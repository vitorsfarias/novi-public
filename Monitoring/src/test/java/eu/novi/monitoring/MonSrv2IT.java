...
//	@Test
//	public void measure(BundleContext ctx) throws Exception {
...
//		UsernamePassword up = new UsernamePassword("alma","apple");
//		assertEquals("UsernamePwd", service.measure(up, "retek"));
//	}
	...
	public void substrate(BundleContext ctx) throws Exception {
		...
		assertEquals(true, 0 < service.substrate(up, query).split("\n").length);
	}
