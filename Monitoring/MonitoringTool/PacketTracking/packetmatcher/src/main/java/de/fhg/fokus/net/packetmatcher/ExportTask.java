...
public class ExportTask {
	 ...
	 * @throws IOException
	 */
	public ExportTask start() throws IOException {
		logger.debug("Starting export task");
		this.client = new Socket(remoteSocketAddr.getAddress(),
				remoteSocketAddr.getPort());
		if (this.client.isConnected()) {
			logger.debug("ExportTask connected to {}",
