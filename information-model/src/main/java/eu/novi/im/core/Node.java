...
public interface Node extends NodeOrService, NetworkElementOrNode, InterfaceOrNode, Resource {
	...
	BigInteger getHasAvailableLogicalRouters();
	@Iri("http://fp7-novi.eu/im.owl#hasAvailableLogicalRouters")
	void setHasAvailableLogicalRouters(BigInteger hasAvailableLogicalRouters);
	...
	BigInteger getHasLogicalRouters();
	@Iri("http://fp7-novi.eu/im.owl#hasLogicalRouters")
	void setHasLogicalRouters(BigInteger hasLogicalRouters);
